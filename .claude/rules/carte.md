...
Non modificare a mano i JSON **generati** da questa pipeline
(`src/data/ionian.json` e le carte che verranno): la modifica sparisce alla
prima rigenerazione. `src/data/barche.json` non c'entra — quello è scritto
a mano ed è la sua fonte di verità.
