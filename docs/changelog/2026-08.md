...
Voci archiviate da `CHANGELOG.md` quando ha superato le 50 righe.
Sono il ciclo di lavoro della modalità carriera, della flotta e dei
comandi a dito, fino al seme pescato a caso.
